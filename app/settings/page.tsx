    ...
    <PageTransition>
      <div className="mx-auto max-w-2xl px-5 py-10 sm:px-10 sm:py-12">
        ...
        <section className="mb-10">
          ...
          {info && (
            <div className="ev-glass ev-glass-edge relative mb-3 rounded-xl border px-3 py-2.5 text-[13px]">
              {info.fromEnv ? (
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="sk-ant-…"
              autoComplete="off"
              className="flex-1 rounded-lg border px-3 py-2 text-[13.5px] outline-none transition-colors focus:border-[var(--accent)]"
              style={{ background: 'var(--bg)' }}
            />
            <button
              onClick={() => void saveKey()}
              disabled={saving}
              className="ev-btn ev-btn-primary rounded-lg px-4 py-2 text-[13px] disabled:opacity-50"
        ...
        <section className="mb-10">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={reindexing}
              className="ev-btn rounded-lg border px-3 py-1.5 text-[13px] hover:bg-[var(--bg-hover)] disabled:opacity-50"
            >
              検索索引を再構築
            </button>
            <button
              ...
              disabled={reindexing}
              className="ev-btn flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-[13px] hover:bg-[var(--bg-hover)] disabled:opacity-50"
            >
        ...
        {message && (
          <p
            className="ev-glass ev-anim-pop relative rounded-xl border px-3 py-2 text-[13px]"
        ...
        {info?.authMode && info.authMode !== 'open' && (
          <section className="mb-10">
            ...
            <button
              ...
              className="ev-btn rounded-lg border px-3 py-1.5 text-[13px] hover:bg-[var(--bg-hover)]"
            >
              ログアウト
            </button>
          </section>
