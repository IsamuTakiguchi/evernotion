        ...
        {pages === null ? (
          ...
          <div className="space-y-2">
            {pages.map((page) => (
              <div
                key={page.id}
                className="ev-glass ev-lift flex flex-col gap-2 rounded-lg border px-3 py-2.5 sm:flex-row sm:items-center"
              >
                ...
                <div className="flex shrink-0 gap-2">
                  <button
                    ...
                    className="ev-btn rounded-lg border px-2.5 py-1 text-[12.5px] hover:bg-[var(--bg-hover)] disabled:opacity-50"
                  >
                    元に戻す
                  </button>
                  <button
